# Schematic Plan (net-by-net) — singlee22-mini-microsd

Build this in KiCad: place the symbols from BOM.csv, then wire the nets
below. Or import `tucklet-singlee22-mini-microsd.net` into Pcbnew to start the
board with a ratsnest directly (logical netlist; reconcile module pins
via PIN_MAP.md).

Variant: **Single ESP32-E22 (Wi-Fi 6E)**, **microSD (swappable)**, **Mini (Compact)**.

## Power tree
`VBUS` (USB-C) -> U3 charge in; `VBAT` (BT1 <-> U3 VBAT <-> U4 CELL);
`VSYS` (U3 SYS -> U5 VIN); `+3V3` (U5 SW(LX) -> U1, U2, U4, U6, storage, LED, pull-ups).
...
| Net | Nodes (ref.pin) |
|---|---|
| `3V3` | U1.2, U4.3, U5.3, U6.5, U6.17, U6.21, R4.2, R5.2, R6.2, LED1.4, R7.2, R8.2, R9.2, R10.2, R11.2, J2.4 |
...
| `GND` | U1.1, U1.28, U1.29, U2.27, U4.4, U4.9, U5.2, U6.2, U6.11, U6.25, J1.1, J1.2, J1.3, J1.4, J1.A1B12, J1.B1A12, D1.3, R1.2, R2.2, R3.2, SW1.2, LED1.2, J2.6, J2.10, J2.11, J2.12, J2.13, J2.14, BT1.2 |
| `GND_PAD` | U2.33, U3.25 |
...
| `SD_CLK` | U6.9, J2.5 |
| `SD_CMD` | U6.4, R7.1, J2.3 |
| `SD_D0` | U6.6, R8.1, J2.7 |
| `SD_D1` | U6.7, R9.1, J2.8 |
| `SD_D2` | U6.1, R10.1, J2.1 |
| `SD_D3` | U6.3, R11.1, J2.2 |
| `SD_DET` | U1.23, J2.9 |
| `SD_SEL` | U1.21, U6.24 |
...
power -> U1 -> storage + U6 mux -> U2 bridge -> I2C/UI -> charger/gauge. Export the
