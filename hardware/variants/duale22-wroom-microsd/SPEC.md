# Variant Spec — duale22-wroom-microsd

**Dual ESP32-E22 (High-Performance) + microSD (swappable) (Standard (WROOM))**
...
- `tucklet-duale22-wroom-microsd.net` — KiCad logical netlist.
