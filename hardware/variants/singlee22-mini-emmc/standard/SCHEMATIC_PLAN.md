...
| Net | Nodes (ref.pin) |
|---|---|
| `3V3` | U6.VCC, R4.2, R5.2, R6.2, LED1.VDD, R7.2, R8.2, R9.2, R10.2, R11.2, XU7.VCC, XU7.VCCQ |
| `BTN` | R6.1, SW1.1 |
| `CC1` | J1.A5, R1.1 |
| `CC2` | J1.B5, R2.1 |
| `EN` | U1.EN, U5.3 |
| `GND` | U1.GND, U2.5, U4.4, U5.2, U6.GND, J1.A1, J1.B1, J1.A12, J1.B12, D1.3, R1.2, R2.2, R3.2, SW1.2, LED1.GND, XU7.VSS, XU7.VSSQ, BT1.2 |
| `GND_PAD` | U2.32, U3.24 |
