# Variant Spec — dualc5-emmc

**Dual ESP32-C5 (link-aggregated, experimental) + eMMC (sealed)**

## What this board is
A Tucklet build with the dual esp32-c5 (link-aggregated, experimental) radio and
emmc (sealed) storage. It shares the entire common
...
## Dimensions
Enclosure envelope: **32 x 24 x 8 mm** (AirTag-class). The ESP32-C5 module
...
- `tucklet-dualc5-emmc.net` — KiCad-importable netlist (Pcbnew > Import Netlist).
...
- [ ] Validate SDIO timing to the eMMC.
